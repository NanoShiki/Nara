...
#include "NaraUserFacingExperienceDefinition.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(NaraUserFacingExperienceDefinition)

UCommonSession_HostSessionRequest* UNaraUserFacingExperienceDefinition::CreateHostingRequest(const UObject* WorldContextObject) const
{
	...
	if (!Result)
	{
		...
		// 此代码块执行的代码跟Subsystem->CreateOnlineHostSessionRequest()中执行的代码完全相同
