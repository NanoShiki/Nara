...
#include "NaraGameViewportClient.h"

#include "CommonUISettings.h"
#include "ICommonUIModule.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(NaraGameViewportClient)
...
UNaraGameViewportClient::UNaraGameViewportClient()
	: Super(FObjectInitializer::Get())
{
}

void UNaraGameViewportClient::Init(struct FWorldContext& WorldContext, UGameInstance* OwningGameInstance, bool bCreateNewAudioDevice)
{
