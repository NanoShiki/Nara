...
#include "NaraFrontendStateComponent.generated.h"
...
UCLASS(Abstract)
class UNaraFrontendStateComponent : public UGameStateComponent, public ILoadingProcessInterface
{
	GENERATED_BODY()

public:

	UNaraFrontendStateComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
private:
	void OnExperienceLoaded(const UNaraExperienceDefinition* Experience);
